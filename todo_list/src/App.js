...
const App = () => {
  ...
  // todoEditing stores the id of todos for which edit button is pressed.

  // now we will add useEffect hook that will be responsible to save new todos in the localstorage.
  useEffect(()=> {
